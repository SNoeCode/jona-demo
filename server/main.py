...
# from app.routers.scraper_router.zip_route import router as zip_router  # Deleted - using playwright/selenium instead
...
from app.routers.scraper_router.zip_selenium_route import router as zip_selenium_router
...
# scraper_router.include_router(zip_router, prefix="/zip", tags=["zip"])  # Deleted - using playwright/selenium instead
...
scraper_router.include_router(zip_selenium_router, prefix="/zip-selenium", tags=["zip-selenium"])
