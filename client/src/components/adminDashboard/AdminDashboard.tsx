...
//               <JobManagement
//                 user={user}
//                 initialJobs={initialJobs} // ✅ use the prop passed from page.tsx
//                 totalJobs={initialStats.totalJobs} // optional, if needed
//                 onStatsUpdate={() => {
//                   // You can define refresh logic here or pass a function
